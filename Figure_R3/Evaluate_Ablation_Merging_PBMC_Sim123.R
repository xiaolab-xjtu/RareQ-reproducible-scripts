...
Evaluate.parameter.F1 <- function(parameter.list, parameter.symbol){
  ...
  saveRDS(perf.mat1.out, file = paste0('Result/Sim-PBMC-1_', 'Ablation_Merging', '_F1.RDS'))
  saveRDS(perf.mat2.out, file = paste0('Result/Sim-PBMC-2_', 'Ablation_Merging', '_F1.RDS'))
  saveRDS(perf.mat3.out, file = paste0('Result/Sim-PBMC-3_', 'Ablation_Merging', '_F1.RDS'))
...
p.k <- Evaluate.parameter.F1(parameter.list = ks, parameter.symbol = 'Ablation_Merging')
...
Evaluate.parameter.NMI <- function(parameter.list, parameter.symbol){
  ...
  saveRDS(perf.mat1.out, file = paste0('Result/Sim-PBMC-1_', 'Ablation_Merging', '_NMI.RDS'))
  saveRDS(perf.mat2.out, file = paste0('Result/Sim-PBMC-2_', 'Ablation_Merging', '_NMI.RDS'))
  saveRDS(perf.mat3.out, file = paste0('Result/Sim-PBMC-3_', 'Ablation_Merging', '_NMI.RDS'))
