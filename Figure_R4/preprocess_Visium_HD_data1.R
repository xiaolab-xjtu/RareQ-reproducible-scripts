setwd('/home/rstudio/Projects/Rare_cell/data/Xenium/Validation/Visium_10X/Data1/')
...
# object <- FindClusters(object, resolution = 0.5) # Very slow and over clustering, Not run
